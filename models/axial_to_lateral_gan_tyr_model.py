...
class AxialToLateralGANTyrModel(BaseModel):
    """
    ...
    This model is a successor to Bragi.
    In comparison to Heimdall model,
    1) It takes projection from 1 to a pre-set depth, not once but multiple times.
    2) It does adaptive instance normalization in generators.
    ...
    def forward(self):
        ...
        self.encode = self.netG_film(self.real_src) # For adaptive normalization.
