...
class AxialToLateralGANBorrModel(BaseModel):
    """
    ...
    This model is a successor to Idun; this model removes the backward path completely.
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_tgt', 'real_src', 'fake']
